...
- fix(patch-v0.27.3): backport yaml expansion fix by @ecrupper in [#1362](https://github.com/go-vela/server/pull/1355) - thanks [@ecrupper](https://github.com/ecrupper)!

### 📦 go-vela/worker

- fix(secret): leverage outputs for secret container execution by @ecrupper in [#664](https://github.com/go-vela/worker/pull/664) - thanks [@ecrupper](https://github.com/ecrupper)!
