...
* (sdk-go fix(version): bump to 0.13 in [163](https://github.com/go-vela/sdk-go/pull/163)
...
* (worker) fix(ci): Fix silent failures in GHA reviewdog workflow in [319](https://github.com/go-vela/worker/pull/319)
