...
- `v0.24.x` introduces a number of changes to API responses and a migration of `github.com/go-vela/types` to `github.com/go-vela/server`. If you depend on either, please update your references as needed. Reference the Breaking Changes section above for details.
...
- (ui) chore: remove allow_ fields from repo and events from secrets [#787](https://github.com/go-vela/ui/commit/b444f1dc812f543cfc5a13f99128c35d56715fe0) - thanks [@ecrupper](https://github.com/ecrupper)!
