...
In the response body, a `Repo` object, has replaced `RepoID`. Check out our (api reference docs)[https://go-vela.github.io/docs/reference/api/build/get/] for an example.
...
In the response body, a `Repo` object, has replaced `RepoID`. Check out our (api reference docs)[https://go-vela.github.io/docs/reference/api/schedule/get/] for an example.
...
In the response body, a `User` object, has replaced `UserID`. Check out our (api reference docs)[https://go-vela.github.io/docs/reference/api/repo/get/] for an example.
