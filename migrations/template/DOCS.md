...
cd $HOME/go-vela/community/migrations/<VELA_VERSION>
```
...
#
# * $HOME/go-vela/community/migrations/<VELA_VERSION>/release/darwin/amd64/vela-migration
# * $HOME/go-vela/community/migrations/<VELA_VERSION>/release/linux/amd64/vela-migration
# * $HOME/go-vela/community/migrations/<VELA_VERSION>/release/linux/arm64/vela-migration
# * $HOME/go-vela/community/migrations/<VELA_VERSION>/release/linux/arm/vela-migration
# * $HOME/go-vela/community/migrations/<VELA_VERSION>/release/windows/amd64/vela-migration
```
