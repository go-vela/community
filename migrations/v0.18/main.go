...
func main() {
	...
	app.Usage = "Vela utility used to migrate from v0.17.x to v0.18.x"
	...
	app.Flags = []cli.Flag{
		...
		&cli.BoolFlag{
			...
			Name:    "action.all",
			Usage:   "enables running all actions for v0.18.x",
		},
		&cli.BoolFlag{
			EnvVars: []string{"VELA_ALTER_TABLES", "ALTER_TABLES"},
			Name:    "alter.tables",
			Usage:   "enables altering the table configuration for v0.18.x",
		},
