...
func (d *db) Validate() error {
	...
	case d.Actions.AlterTables:
		fallthrough
	case d.Actions.UpdateRepos:
		if !d.Actions.AlterTables {
			logrus.Warning("cannot execute UpdateRepos action without altering repos table first")
		}
		fallthrough
	case d.Actions.UpdateSecrets:
		if !d.Actions.AlterTables {
			logrus.Warning("cannot execute UpdateSecrets action without altering secrets table first")
		}
		fallthrough
	case d.Actions.All:
		break
